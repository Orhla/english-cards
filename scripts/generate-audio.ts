...
import { AUDIO_DIR, ENGLISH_US_LANG_CODE, YANDEX_API_KEY } from "@/lib/consts";
...
async function getEnglishAudioFiles() {
    ...
    await asyncPool(allCards.data, POOL_LIMIT, (item) => withRetry(() => generateEnglishAudioFile(item, ENGLISH_US_LANG_CODE)));
}
